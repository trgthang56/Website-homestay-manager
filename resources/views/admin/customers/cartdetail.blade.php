    ...
    @if(optional($cart)->count() > 0)
     <div class="container">
      ...
      @csrf
        ...
        <div class="card"  style="margin: 20px 0px;  box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
          <div class="card-header">
            <h4 style="margin: 0px">Dịch vụ và yêu cầu trước cho phòng</h4>
          </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label for="serviceToggle-{{ $datum->idRoom }}" class="custom-control-label"
                      onclick="toggleServiceList('{{$datum->idRoom}}')">Các dịch vụ đi kèm</label>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="form-group" style="margin: 0px;">
                  <label for="special_requirement">Yêu cầu đặc biệt <i class="fa-regular fa-circle-question"
                      ...
                      title="Chúng tếaaaaôi sẽ cố gắng đáp ứng yêu cầu của bạn dựa trên tình trạng sẵn có. Lưu ý rằng bạn có thể phải trả thêm phí cho một số yêu cầu và bạn không thể sửa yêu cầu sau khi đã gửi."></i></label>
                </div>
              </div>
            </div>
            <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12" style="padding-left: 20px">
                    <div class="form-group">
                      ...
                      <span class="float-right ">{{ number_format($datum->price, 0, '.', ',') }} VNĐ</span>
                      <span class="room-price" style="display: none">{{ $datum->price }} VNĐ</span>
                    </div>
                  </div>
                  @endforeach
                </div>
            ...
            <a type="button" class="btn btn-success float-right" data-toggle="modal" data-target=".bd-example-modal-lg-payment-method" style="color: white">Phương thức thanh toán</a>
...
<script>
  ...
  function calculateTotalServicesPrice() {
    var cartArray = {!! $cart-> toJson()!!};
    var TotalServicesPrice = 0;
    // Lặp qua mảng JavaScript và in ra console
  ...
  // Tính tổng giá phòng và hiển thị
  function calculateTotalRoomsPrice() {
    ...
    roomPrices.forEach(function (roomPriceElement) {
      var roomPriceText = roomPriceElement.textContent.trim(); // Lấy nội dung văn bản của phần tử, loại bỏ khoảng trắng ở hai đầu
      var roomPrice = parseInt(roomPriceText.split(' ')[0].replace(',', '')); // Lấy giá phòng và chuyển đổi thành số nguyên
