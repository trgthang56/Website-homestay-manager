      ...
      <div class="col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title"><a class="nav-link" style="padding: 0px; color: white;">Tìm kiếm (không xem được
                phòng đang bận)</a></h3>
          </div>
          <div class="card-body">
            ...
            <tr>
              ...
              <td class="project-actions text-right">
                <a class="btn btn-primary btn-sm" style="padding: 0 0 0 0;">
                  <form action="room/detail/{{$datum->id}}" method="get" class="active">
                    @csrf
                ...
                <a class="btn btn-info btn-sm" style="padding: unset;">
                  <form action="room/edit/{{$datum->id}}" method="post" class="active">
                  @csrf
