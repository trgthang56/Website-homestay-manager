        ...
        <div class="col-md-3">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              @else
              @php
                if($user->id_bill== null){
                  $count =0;
                }else{$numbersArray = explode(", ", $user->id_bill);
                $count = count($numbersArray);
                }
              @endphp
              <ul class="list-group list-group-unbordered mb-3">
                <li class="list-group-item">
                  <b>Ngày tạo</b> <a class="float-right">{{$user->created_at->format('H:i - d/m/Y')}}</a>
                </li>
                <li class="list-group-item">
                  <b>Đơn của bạn</b><a class="float-right">{{$count}}</a>
                </li>
                <li class="list-group-item">
                  <b>thẻ thành viên</b> <a class="float-right">đang phát triển</a>
                </li>
          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" href="#infomation" data-toggle="tab">Thông tin nhân
                    viên</a></li>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            @else
                            <p style="font-size: 18px;">Trống</p>
                            @endif
                          </div>
                        </div>
                        <div class="col-md-6">
