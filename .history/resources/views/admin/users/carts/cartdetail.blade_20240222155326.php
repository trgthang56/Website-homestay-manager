      ...
      <form action="" method="post">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <input type="submit" value="Thanh Toán" class="btn btn-success float-right"></input>
...
<script>
  function toggleCardBody(roomId) {
    var cardBodyContent = document.getElementById(roomId);
    var icon = document.getElementById("icon-" + roomId);

    if (cardBodyContent.style.display === "none") {
