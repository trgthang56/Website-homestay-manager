      ...
      <form action="" method="post">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="card-header" style="cursor:pointer; border-bottom: solid 1px #000;"
              onclick="toggleCardBody({{ $datum->idRoom }})">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      ...
                      <label for="{{ $service->id }}" class="custom-control-label" style="font-weight: normal;">{{
                        $service->name }}</label>
                      <label for="{{ $service->id }}" class="service-price float-right" style="font-weight: normal;">{{
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" type="checkbox" name="rqCheckbox[]"
                        id="others-{{ $datum->idRoom }}" data-toggle="collapse"
                        href="#collapseOne-{{ $datum->idRoom }}">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                      ...
                      <label for="bed-{{ $datum->idRoom }}" class="custom-control-label"
                        style="font-weight: normal;">Loại giường</label>
                    </div>
                  </div>
                </div>
...
<script>
  document.getElementById('serviceToggle').addEventListener('click', function () {
    // Lấy thẻ có class là 'service-list'
    var serviceList = document.querySelector('.service-list');
    // Kiểm tra trạng thái checked của checkbox 'serviceToggle'
    if (this.checked) {
      // Nếu được chọn, hiển thị thẻ chứa danh sách dịch vụ
      serviceList.style.display = 'block';
    } else {
      // Nếu không được chọn, ẩn thẻ chứa danh sách dịch vụ
